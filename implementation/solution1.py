...
if vehicle_1.verifica_credencial(fake_vehicle):
    ...
    #alterar para ao inves de id, usar a credencial
    vehicle_1.pendingMessages.append((message_1, fake_vehicle.getName(), fake_vehicle.id))
    vehicle_1.pendingMessages.append((message_2, fake_vehicle.getName(), fake_vehicle.id))
...
if enb_ran.verifica_credencial(fake_vehicle):
